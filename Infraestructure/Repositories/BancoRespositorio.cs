...
{
    public class BancoRespositorio : CrudCoreRespository<Banco , int>, IBancoRepositorio
    {
        private readonly ApplicationDbContext _context;
        public BancoRespositorio(ApplicationDbContext context) : base(context) => _context = context;

        public async Task<PaginadoResponse<Banco>> BusquedaPaginado(PaginationRequest dto)
        {
            var contex = _context.Set<Banco>().AsQueryable();
            ...
            PaginadoResponse<Banco> response = new(data, meta);
