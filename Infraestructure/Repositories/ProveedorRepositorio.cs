...
{
    public class ProveedorRespositorio : CrudCoreRespository<Proveedor, int>, IProveedorRepositorio
    {
        private readonly ApplicationDbContext _context;
        public ProveedorRespositorio(ApplicationDbContext context) : base(context) => _context = context;
        ...
        public async Task<PaginadoResponse<Proveedor>> BusquedaPaginado(PaginationRequest dto)
        {
            ...
            PaginadoResponse<Proveedor> response = new(data, meta);

            return response;
        }

        public async Task<IReadOnlyList<Proveedor>> SelectActivo()
        {
        ...
        public async override Task<Proveedor?> FindByIdAsync(int id)
        {
            var response = await _context.Set<Proveedor>()
        ...
        public async override Task<IReadOnlyList<Proveedor>> FindAllAsync()
        {
            return await _context.Set<Proveedor>()
                                 .Include(c => c.TipoDocumento)
                                 .AsNoTracking()
