...
namespace Infraestructure.Repositories
{
    public class CategoryRespositorio(ApplicationDbContext context) : CrudCoreRespository<Category, int>(context), ICategoryRepositorio
    {
        ...
        public async Task<PaginadoResponse<Category>> BusquedaPaginado(PaginationRequest dto)
        {
            var contex = _context.Set<Category>().AsQueryable();
            ...
            PaginadoResponse<Category> response = new(data, meta);
