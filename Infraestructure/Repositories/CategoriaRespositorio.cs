...
{
    public class CategoriaRespositorio(ApplicationDbContext context) : CrudCoreRespository<Categoria, int>(context), ICategoriaRepositorio
    {
        ...
        public async Task<PaginadoResponse<Categoria>> BusquedaPaginado(PaginationRequest dto)
        {
            ...
            PaginadoResponse<Categoria> response = new(data, meta);
